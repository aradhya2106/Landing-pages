...
const usps = [
  {
    ...
    description:
      "We don't rely on generic benchmarks - we measure what matters in human–AI interaction.",
  },
  {
    icon: Globe2,
    title: "Talent Onboarding at Scale",
    description:
      "Through global OEM partnerships and programmatic digital media distribution.",
  },
  {
    icon: Sparkles,
    title: "Untapped Territories",
    description:
      "Like Asia, Africa, and the Middle East, with growing smartphone users.",
  },
  {
    icon: TrendingUp,
    title: "Cost-Effective Pipelines",
    description:
      "Scalable human-in-the-loop workflows that deliver enterprise-quality results at competitive prices.",
  },
];
