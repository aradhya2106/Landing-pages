...
const WhyUs = () => {
  return (
    <section id="why-us" className="pt-16 pb-12 md:py-32 relative overflow-hidden">
      {/* Background Effects */}
          ...
          >
            {reasons.map((reason, index) => (
              <motion.div
                ...
                className="glass rounded-xl p-4 md:p-6 flex gap-3 md:gap-4 group hover:border-primary/30 transition-all duration-300"
              >
