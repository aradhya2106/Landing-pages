...
const useCases = [
  { icon: Globe, label: "Agentic Browsing", color: "text-primary" },
  { icon: Code, label: "Coding", color: "text-secondary" },
  { icon: Car, label: "Autonomous Vehicles", color: "text-primary" },
  {
    icon: Glasses,
    label: "Smart Glasses & Wearables",
      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            High-Impact <span className="text-gradient">Domains</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Our infrastructure powers AI agents systems across industries where
